...
public class ImageToolkitCompRegErr implements ImageToolkitComparator {
    ...
    private static void testCompare(String fileA, String fileB) throws IOException {
    	...
    	System.out.println("" + new ImageToolkitCompRegErr().compare(imgA, imgB));
    }
	...
	result1 = SSE1 / (n * sqr((double) ImageToolkitCompRegErr.MAX / 2));
	result2 = SSE2 / (n * sqr((double) ImageToolkitCompRegErr.MAX / 2));
